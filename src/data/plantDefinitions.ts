...
const FAMILY_GENUS: Record<string, { family: string; genus: string }> = {
  ...
  p055: { family: 'スミレ科 (Violaceae)', genus: 'スミレ属 (Viola)' },
  p056: { family: 'ワスレグサ科 (Hemerocallidaceae)', genus: 'ワスレグサ属 (Hemerocallis)' },
  p057: { family: 'シソ科 (Lamiaceae)', genus: 'オドリコソウ属 (Lamium)' },
  p058: { family: 'キク科 (Asteraceae)', genus: 'ノゲシ属 (Sonchus)' },
  p059: { family: 'カヤツリグサ科 (Cyperaceae)', genus: 'カヤツリグサ属 (Cyperus)' },
  p060: { family: 'ヒルガオ科 (Convolvulaceae)', genus: 'ヒルガオ属 (Calystegia)' },
  p061: { family: 'シソ科 (Lamiaceae)', genus: 'キランソウ属 (Ajuga)' },
  p062: { family: 'イネ科 (Poaceae)', genus: 'チガヤ属 (Imperata)' },
  p063: { family: 'シソ科 (Lamiaceae)', genus: 'クサギ属 (Clerodendrum)' },
  p064: { family: 'マメ科 (Fabaceae)', genus: 'ゲンゲ属 (Astragalus)' },
  p065: { family: 'セリ科 (Apiaceae)', genus: 'ドクニンジン属 (Conium)' },
  p066: { family: 'ケシ科 (Papaveraceae)', genus: 'タケニグサ属 (Macleaya)' },
  p067: { family: 'ドクダミ科 (Saururaceae)', genus: 'ハンゲショウ属 (Saururus)' },
  p068: { family: 'キク科 (Asteraceae)', genus: 'ヤブタビラコ属 (Lapsana)' },
  p069: { family: 'キク科 (Asteraceae)', genus: 'オニタビラコ属 (Youngia)' },
  p070: { family: 'アカバナ科 (Onagraceae)', genus: 'マツヨイグサ属 (Oenothera)' },
  p071: { family: 'ドクウツギ科 (Coriariaceae)', genus: 'ドクウツギ属 (Coriaria)' },
  p072: { family: 'キョウチクトウ科 (Apocynaceae)', genus: 'キョウチクトウ属 (Nerium)' },
  p073: { family: 'ウルシ科 (Anacardiaceae)', genus: 'ウルシ属 (Toxicodendron)' },
  p074: { family: 'マメ科 (Fabaceae)', genus: 'フジ属 (Wisteria)' },
  p075: { family: 'マメ科 (Fabaceae)', genus: 'ハギ属 (Lespedeza)' },
  p076: { family: 'イネ科 (Poaceae)', genus: 'ススキ属 (Miscanthus)' },
  p077: { family: 'ナデシコ科 (Caryophyllaceae)', genus: 'ナデシコ属 (Dianthus)' },
  p078: { family: 'スイカズラ科 (Caprifoliaceae)', genus: 'オミナエシ属 (Patrinia)' },
  p079: { family: 'キク科 (Asteraceae)', genus: 'ヒヨドリバナ属 (Eupatorium)' },
  ...
  h049: { family: 'コショウ科 (Piperaceae)', genus: 'コショウ属 (Piper)' },
  h050: { family: 'フトモモ科 (Myrtaceae)', genus: 'オールスパイス属 (Pimenta)' },
  h051: { family: 'キク科 (Asteraceae)', genus: 'ステビア属 (Stevia)' },
  h052: { family: 'キク科 (Asteraceae)', genus: 'キンセンカ属 (Calendula)' },
  h053: { family: 'クマツヅラ科 (Verbenaceae)', genus: 'コウスイボク属 (Aloysia)' },
  h054: { family: 'キク科 (Asteraceae)', genus: 'キクニガナ属 (Cichorium)' },
  h055: { family: 'ヒノキ科 (Cupressaceae)', genus: 'ネズ属 (Juniperus)' },
  h056: { family: 'ゴマ科 (Pedaliaceae)', genus: 'ゴマ属 (Sesamum)' },
  h057: { family: 'フトモモ科 (Myrtaceae)', genus: 'バックハウシア属 (Backhousia)' },
  h058: { family: 'ショウガ科 (Zingiberaceae)', genus: 'ハナミョウガ属 (Alpinia)' },
  h059: { family: 'モチノキ科 (Aquifoliaceae)', genus: 'モチノキ属 (Ilex)' },
  h060: { family: 'トケイソウ科 (Passifloraceae)', genus: 'トケイソウ属 (Passiflora)' },
  h061: { family: 'キク科 (Asteraceae)', genus: 'ムギワラギク属 (Helichrysum)' },
  h062: { family: 'アカネ科 (Rubiaceae)', genus: 'ヤエムグラ属 (Galium)' },
  h063: { family: 'アブラナ科 (Brassicaceae)', genus: 'オランダガラシ属 (Nasturtium)' },
  h064: { family: 'セリ科 (Apiaceae)', genus: 'オランダミツバ属 (Apium)' },
  h065: { family: 'アブラナ科 (Brassicaceae)', genus: 'セイヨウワサビ属 (Armoracia)' },
  h066: { family: 'タデ科 (Polygonaceae)', genus: 'イヌタデ属 (Persicaria)' },
  h067: { family: 'マタタビ科 (Actinidiaceae)', genus: 'マタタビ属 (Actinidia)' },
  h068: { family: 'マメ科 (Fabaceae)', genus: 'センナ属 (Senna)' },
  h069: { family: 'マメ科 (Fabaceae)', genus: 'チョウマメ属 (Clitoria)' },
  h070: { family: 'アオイ科 (Malvaceae)', genus: 'フヨウ属 (Hibiscus)' },
  h071: { family: 'スイカズラ科 (Caprifoliaceae)', genus: 'スイカズラ属 (Lonicera)' },
};
